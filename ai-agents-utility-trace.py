...
USAGE:
    python agents-code-interpreter-modular.py
...
print(os.environ["AZURE_TRACING_GEN_AI_CONTENT_RECORDING_ENABLED"])
...
#project_client.telemetry.enable(destination="console")
...
def run_agent(thread_id: str, agent_id: str):   
    ...
    if run.status == "failed":
        ...
        return {"run_id":run.id, "run_status":0, "error": run.last_error}
